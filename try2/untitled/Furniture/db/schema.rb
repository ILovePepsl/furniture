...
ActiveRecord::Schema[7.1].define(version: 2024_05_18_172635) do
  ...
  create_table "collections", force: :cascade do |t|
    ...
    t.string "product_card_background_color"
    t.string "product_description_color"
  ...
  create_table "order_products", force: :cascade do |t|
    ...
    t.date "manufacturer_start_date"
    t.date "manufacturer_end_date"
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["manufacturer_id"], name: "index_subscriptions_on_manufacturer_id"
  ...
  add_foreign_key "subscriptions", "users", column: "manufacturer_id"
